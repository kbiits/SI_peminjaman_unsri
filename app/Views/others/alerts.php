      ...
      <li class="nav-item  active">
        ...
        <div id="collapseBootstrap" class="collapse show" aria-labelledby="headingBootstrap"
          ...
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item  active" href="alerts.php">Alerts</a>
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <div class="row">
            <div class="col-lg-12 text-center">
              <p>
                For more documentations you can visit<a href="https://getbootstrap.com/docs/4.3/components/alerts/alerts.php"
