...
<body class="bg-gradient-login">
    ...
    <div class="container-login">
        <?php if ($msg = session()->getFlashdata('wrong-credentials')) : ?>
                                ...
                                <div class="login-form">
                                    ...
                                    <form action="/login" method="post" id="form-login">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control <?= isset($validator) && $validator->hasError('email_or_nim') ? 'is-invalid' : '' ?>" id="email_or_nim" aria-describedby="emailHelp" name="email_or_nim" placeholder="Masukkan Email atau NIM">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" name="password" class="form-control <?= isset($validator) && $validator->hasError('password') ? 'is-invalid' : '' ?>" id="password" placeholder="Password">
