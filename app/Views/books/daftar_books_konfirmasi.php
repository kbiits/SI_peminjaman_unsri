...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Konfirmasi Pengembalian Buku</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="./">Home</a></li>
            <li class="breadcrumb-item">Buku</li>
            <li class="breadcrumb-item active" aria-current="page"><a href="/tools/show">Konfirmasi Pengembalian
                    Buku</a></li>
        </ol>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Daftar Pinjaman Buku Yang Belum Dikonfirmasi</h6>
                </div>
                    ...
                    <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                        ...
                        foreach ($pinjaman as $p) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="/books/<?= esc($p->isbn) ?>/konfirmasi/<?= esc($p->id) ?>"
