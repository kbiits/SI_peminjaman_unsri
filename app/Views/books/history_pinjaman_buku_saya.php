...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Riwayat Pinjaman Buku <?= session('user')['name'] ?></h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="./">Home</a></li>
            <li class="breadcrumb-item">Buku</li>
            <li class="breadcrumb-item active" aria-current="page"><a href="/books/history">Riwayat Pinjaman Buku
                    Saya</a></li>
        </ol>
    </div>
    ...
    $(document).ready(function() {
        $('#dataTableHover').DataTable({
            ...
            buttons: [{
                    extend: 'pdfHtml5',
                    exportOptions: {},
                    title: "Riwayat Pinjaman Buku <?= session('user')['name'] ?>",
                    className: 'btn btn-info btn-sm mr-2',
                    download: 'open',
                    pageSize: 'A4',
                    messageTop: 'Riwayat Pinjaman Buku',
                },
                {
                    extend: 'excelHtml5',
                    exportOptions: {},
                    title: "Riwayat Pinjaman Buku <?= session('user')['name'] ?>",
                    className: 'btn btn-info btn-sm mr-2',
                    sheetName: 'Riwayat Pinjaman Buku',
                }
            ],
