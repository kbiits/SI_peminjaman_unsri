...
?>
    ...
    <div class="container-fluid" id="container-wrapper">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Menambahkan Alat Baru</h1>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="./">Home</a></li>
                <li class="breadcrumb-item">Alat</li>
                <li class="breadcrumb-item active" aria-current="page"><a href="/tools/create-tools">Tambahkan Alat
                        Baru</a>
                </li>
            </ol>
        </div>
            ...
            <div class="col">
                <div class="card px-3 py-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Menambahkan Alat Baru</h6>
                    </div>
                    <div class="card-body">
                        <form action="/tools" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                       ...
                                       id="name" aria-describedby="emailHelp" placeholder="Masukkan Nama Alat"
                                       name="name">
                            ...
                            <div class="form-group">
                                <label for="stock">Stok Alat</label>
                                <input type="number"
                                       class="form-control <?= isset($validator) && $validator->hasError('stock') ? esc('is-invalid') : '' ?>"
                                       id="stock" aria-describedby="stock" placeholder="Masukkan Banyak Stok Alat"
                                       name="stock">
